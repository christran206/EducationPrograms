...
#Generalized Suffix Tree Code taken from Stack Overflow
class Node(object):
...
if __name__ == '__main__':
    ...
    suffTree = GeneralizedSuffixTree(inp)

    edges = (suffTree.edge_substring(e) for e in suffTree.edges.values())
    for edge in edges:
        if '$' in edge:

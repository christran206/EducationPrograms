...
; following a command will wait until command has completed before executing next command
...
While loop to process and execute commands using starting and ending indexes

...
int main() {
   ...
   cout << "test == " << endl;
   cout << "--------" << endl;
   Employee emp1("Stewart", "Shad");      // last name, first name
   Employee emp2("Heath", "Judah");
   ...
   cout << "-----------------------------" << endl;
   Employee emp3("Benjamin", "Montoya");
   Employee emp4("Garrett", "Gilmore");
   ...
   Employee emp5("Phillip", "Ewing");
   Employee emp6("Lucian", "Newton");
   Employee emp7("Dean", "Conway");
   ...
   company10.merge(company10,company10);

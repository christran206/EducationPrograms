...
int main() {
	...
	cout << "Compute A * B = " << A * B << endl;			// A * B = { 3 9}
	...
	bool success;
	cout << D.insert(-20000) << endl;           // handle value out of range
	cout << D.remove(20000) << endl;            // handle value out of range
	cout << D.remove(-5000) << endl;            // handle value out of range
	cout << D.insert(0) << endl;                // put 0 in the set
	cout << D.insert(20000) << endl;            // handle as you'd like, resize or not
